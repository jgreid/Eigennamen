 ...
 */
export function safeSetStorage(storage: Storage, key: string, value: string): boolean {
    try {
 ...
 */
export function safeGetStorage(storage: Storage, key: string): string | null {
    try {
 ...
 * @param key - Storage key
 */
export function safeRemoveStorage(storage: Storage, key: string): void {
    try {
