 ...
 */
export function showSpymasterView() {
 ...
 */
export function isCurrentTeamClickerUnavailable() {
 ...
 */
export function isClickerFallback() {
 ...
 */
export function canActAsClicker() {
