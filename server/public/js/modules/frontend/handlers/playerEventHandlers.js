...
export function registerPlayerHandlers() {
    EigennamenClient.on('playerJoined', (data) => {
        if (data.players) {
    ...
    EigennamenClient.on('playerLeft', (data) => {
        if (data.players) {
            state.multiplayerPlayers = data.players;
        }
    ...
    EigennamenClient.on('playerUpdated', (data) => {
    ...
    EigennamenClient.on('playerDisconnected', (data) => {
    ...
    EigennamenClient.on('playerReconnected', (data) => {
...
//# sourceMappingURL=playerEventHandlers.js.map