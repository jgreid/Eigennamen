 ...
 * @param {string} lang - Language code (en, de, es, fr)
 ...
 * @param {string} key - Dot-separated key (e.g., 'game.redTurn')
 * @param {Object} params - Interpolation parameters (e.g., {team: 'Red'})
 ...
 * @param {Object} obj
 * @param {string} path - e.g., 'game.turn.red'
 * @returns {*}
 */
